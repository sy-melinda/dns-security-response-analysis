...
![Baseline DNS Query](assets/screenshots/01-dig-before-dns-change.png)
...
![DNS Nameserver Configuration](assets/screenshots/02-interface-dns-nameserver-config.png)
...
![DNS Query After Configuration](assets/screenshots/03-dig-after-dns-change.png)
...
![Client DNS Query](assets/screenshots/04-client-dig-baseline.png)
...
![Wireshark DNS Capture](assets/screenshots/05-wireshark-dns-capture.png)
...
![Netwag DNS Response Configuration](assets/screenshots/06-netwag-fake-dns-response-config.png)
...
![Repeated DNS Query](assets/screenshots/07-client-dig-repeat.png)
...
![DNS Response in Wireshark](assets/screenshots/08-wireshark-dns-response.png)
...
![DNS Response Details](assets/screenshots/09-wireshark-dns-response-details.png)
...
![Custom DNS Response Configuration](assets/screenshots/10-netwag-custom-dns-response-config.png)
...
![Final DNS Response Validation](assets/screenshots/11-dig-final-response-validation.png)

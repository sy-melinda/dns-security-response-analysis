...
![Baseline DNS Query](asssets/screenshots/01-dig-before-dns-change.png)
...
![DNS Nameserver Configuration](asssets/screenshots/02-interface-dns-nameserver-config.png)
...
![DNS Query After Configuration](asssets/screenshots/03-dig-after-dns-change.png)
...
![Client DNS Query](asssets/screenshots/04-client-dig-baseline.png)
...
![Wireshark DNS Capture](asssets/screenshots/05-wireshark-dns-capture.png)
...
![Netwag DNS Response Configuration](asssets/screenshots/06-netwag-fake-dns-response-config.png)
...
![Repeated DNS Query](asssets/screenshots/07-client-dig-repeat.png)
...
![DNS Response in Wireshark](asssets/screenshots/08-wireshark-dns-response.png)
...
![DNS Response Details](asssets/screenshots/09-wireshark-dns-response-details.png)
...
![Custom DNS Response Configuration](asssets/screenshots/10-netwag-custom-dns-response-config.png)
...
![Final DNS Response Validation](asssets/screenshots/11-dig-final-response-validation.png)
